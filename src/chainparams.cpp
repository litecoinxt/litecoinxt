...
public:
    CMainParams() {
        ...
        // Litecoin XT: Mainnet v2 enforced as of block 710k
...
public:
    CTestNetParams() {
        ...
        // Litecoin XT: Testnet v2 enforced as of block 400k
...
public:
    CRegTestParams() {
        ...
        // Litecoin XT: v2 enforced using Bitcoin's supermajority rule

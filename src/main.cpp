...
#if defined(NDEBUG)
# error "Litecoin XT cannot be compiled without assertions."
#endif
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Litecoin XT: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Litecoin XT: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)

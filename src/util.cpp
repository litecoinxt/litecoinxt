...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Litecoin XT
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Litecoin XT
    // Mac: ~/Library/Application Support/Litecoin XT
    // Unix: ~/.litecoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Litecoin XT";
#else
    fs::path pathRet;

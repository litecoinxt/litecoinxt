    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Litecoin XT") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Litecoin XT"), this);
    aboutAction->setStatusTip(tr("Show information about Litecoin XT"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Litecoin XT"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Litecoin XT help message to get a list with possible Litecoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Litecoin XT client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Litecoin XT"); // default title

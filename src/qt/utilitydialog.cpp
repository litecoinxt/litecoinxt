    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Litecoin XT") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Litecoin XT"));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Litecoin XT is shutting down...") + "<br /><br />" +

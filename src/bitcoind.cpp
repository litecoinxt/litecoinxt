...
bool AppInit(int argc, char* argv[])
{
    ...
    {
        std::string strUsage = _("Litecoin XT Daemon") + " " + _("version") + " " + FormatFullVersion() + "\n";
        ...
        {
            strUsage += "\n" + _("Usage:") + "\n" +
                  "  litecoind [options]                     " + _("Start Litecoin XT Daemon") + "\n";
    ...
    try
    {
        ...
        if (fDaemon)
        {
            fprintf(stdout, "Litecoin XT server starting\n");

...
*Setup instructions for a gitian build of Litecoin XT using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Litecoin XT
...
- [Building Litecoin XT](#building-litecoin)
...
Building Litecoin XT
----------------

To build Litecoin XT (for Linux, OSX and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/litecoinxt/litecoinxt

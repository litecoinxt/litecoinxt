UNIX BUILD NOTES
====================
Some notes on how to build Litecoin XT in Unix. 
...
memory available when compiling Litecoin XT. With 512MB of memory or less
compilation will take much longer due to swap thrashing.

Dependencies for the GUI: Ubuntu & Debian
-----------------------------------------

If you want to build Litecoin-XT, make sure that the required packages for Qt development
...
# Configure Litecoin XT to use our own-built instance of BDB
cd $LITECOIN_ROOT

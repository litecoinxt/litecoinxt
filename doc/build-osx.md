...
1. Clone the github tree to get the source code and go into the directory.
        ...
        git clone https://github.com/litecoinxt/litecoinxt.git
        cd litecoin
...
litecoind/litecoin-cli binaries are not included in the Litecoin-XT.app bundle.

If you are building `litecoind` or `Litecoin-XT` for others, your build machine should be set up
...
Once dependencies are compiled, see release-process.md for how the Litecoin-XT.app
...
commands:
    ...
    echo -e "rpcuser=litecoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Litecoin XT/litecoin.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Litecoin XT/litecoin.conf"

The next time you run it, it will start downloading the blockchain, but it won't
output anything while it's doing this. This process may take several hours;
you can monitor its process by looking at the debug.log file, like this:

    tail -f $HOME/Library/Application\ Support/Litecoin\ XT/debug.log
